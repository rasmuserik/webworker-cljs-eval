...
var reader = (function (){var or__40692__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__40692__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__40692__auto__)){
return or__40692__auto__;
} else {
return (128);
...
var map__51544 = top_item;
var map__51544__$1 = ((((!((map__51544 == null)))?((((map__51544.cljs$lang$protocol_mask$partition0$ & (64))) || (map__51544.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51544):map__51544);
var file = cljs.core.get.call(null,map__51544__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__51544__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__51544__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e51543){var _e = e51543;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___51546 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___51546)){
var seen_errors_51547 = temp__4655__auto___51546;
if(cljs.core.truth_(seen_errors_51547.has(self))){
} else {
seen_errors_51547.add(self);

var temp__4657__auto___51548 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___51548)){
var sense_51549 = temp__4657__auto___51548;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_51549)].join('');
} else {
}
}
} else {
...
if(cljs.core.truth_((function (){var and__40680__auto__ = cljs.core.not.call(null,devtools.sanity_hints._STAR_installed_QMARK__STAR_);
...
//# sourceMappingURL=sanity_hints.js.map?rel=1482388921662